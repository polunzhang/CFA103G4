...
<%
  ...
  OnlineOrderVO onlineorderVO = (OnlineOrderVO) session.getAttribute("onlineOrderVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
      <span id="amount">paying: <strong>${onlineorderVO.total}</strong></span>
      <span id="card-image">
  ...
  <button type="button" id="card-btn">信用卡驗證</button>
  
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/shopping_system/Checkout2.do" style="margin-bottom: 0px;">
  <input type="hidden" name="olno" value="<%=onlineorderVO.getOlno()%>">
  <input type="submit" id="checkout" value="完成結帳">
