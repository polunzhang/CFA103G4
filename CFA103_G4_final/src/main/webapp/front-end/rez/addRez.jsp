...
<table>
	<tr style="display:none">
		<td>訂位編號:</td>
		<td><input type="TEXT" placeholder="請新增訂位編號" name="rezno" size="40" 
			 value="<%= (rezVO==null)? "" : rezVO.getRezno()%>" /></td>
	</tr>
	<tr>
		<td class="memno">Member Number 會員編號:</td>
		<td class="memno1"><input type="TEXT" placeholder="非會員可不填" name="memno" size="40"
			 value="<%= (rezVO==null)? "" : rezVO.getMemno()%>" /></td> 
	</tr>
	<tr>
...
<script>
        ...
        //      1.以下為某一天之前的日期無法選擇
              var somedate1 = new Date('2021-12-28');
              $('#date').datetimepicker({
        ...
        //      2.以下為某一天之後的日期無法選擇
              var somedate2 = new Date('2022-01-26');
