...
<%
    ...
    Integer table_status = (Integer)context.getAttribute("table_status");
System.out.println("table_status="+table_status);
    List<TableVO> list = tableSvc.findByTableStatus(table_status);
