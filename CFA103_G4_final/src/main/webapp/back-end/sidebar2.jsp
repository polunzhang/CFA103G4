	...
	<aside class="sidebar">
		...
		<c:if test="<%=list2.contains(5)%>">
					...
					<li class="sub-menu"><a href="javascript:void(0);"><i
						...
						<ul>
							<li><a
								href="<%=request.getContextPath()%>/back-end/emp/listAllEmp.jsp">顯示全部員工</a></li>
							<li><a
								href="<%=request.getContextPath()%>/back-end/emp/select_page.jsp">查詢單一員工</a></li>
							<li><a
								href="<%=request.getContextPath()%>/back-end/emp/addEmp.jsp">員工管理</a></li>
							<li><a
							...
							<li><a
								href="<%=request.getContextPath()%>/back-end/emperDetail/select_page_emper_detail.jsp">權限明細查詢</a></li>
							<li><a
								href="<%=request.getContextPath()%>/back-end/emperDetail/listAllEmperDetail.jsp">所有權限明細</a></li>
							<li><a
