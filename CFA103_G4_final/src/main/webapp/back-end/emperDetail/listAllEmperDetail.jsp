...
List<EmperDetailVO> list = emperDetailSvc.getAll();
pageContext.setAttribute("list", list);
%>

<jsp:useBean id="emperSvc" scope="page"
	class="com.emper.model.EmperService" />
		...
		<table id="customers">
			...
			<c:forEach var="emperDetailVO" items="${list}">
				...
				<tr>
					...
					<!-- 			<td> -->
					<%-- 			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/emperDetail/emperDetail.do" style="margin-bottom: 0px;"> --%>
					<!-- 			     <input type="submit" value="修改"> -->
					<%-- 			     <input type="hidden" name="emperno"  value="${emperDetailVO.emperno}"> --%>
