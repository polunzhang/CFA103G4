...
<%
	...
	Integer olno = (Integer)context.getAttribute("olno");
System.out.println("olno="+olno);
	List<OnlineDetailVO> list = onlineDetailSvc.findByOlno(olno);
...
<head>
<meta charset="UTF-8">
<title>線上訂單明細 - listOneOnlineDetail.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>線上訂單明細 - listOneOnlineDetail.jsp</h3>
