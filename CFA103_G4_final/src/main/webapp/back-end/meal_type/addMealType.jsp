...
<head>
<meta charset="UTF-8">
<title>餐點分類資料新增 - addMealType.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>餐點分類資料新增 - addMealType.jsp</h3></td><td>
...
<!-- 	<tr> -->
<!-- 		<td>餐點分類編號:</td> -->
<!-- 		<td><input type="TEXT" name="meal_type_no" size="45"  -->
<%-- 			 value="<%= (mealTypeVO==null)? "0" : mealTypeVO.getMeal_type_no()%>" /></td> --%>
<!-- 	</tr> -->
	<tr>
		<td>餐點分類名稱:</td>
		<td><input type="TEXT" name="meal_type_name" size="45" 
			 value="<%= (mealTypeVO==null)? "" : mealTypeVO.getMeal_type_name()%>" /></td>
	</tr>
