...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
      <span id="amount">paying: <strong>${liveorderVO.total}</strong></span>
      <span id="card-image">
    ...
    <div id="exp-container">
      ...
      <input id="card-cvc" placeholder="XXX" type="text" min-length="3" max-length="4">
      <p>Last 3 digits</p>
    </div>
    <!--- end CVC container --->
    <!--- end exp container --->
  ...
  <button type="button" id="card-btn">驗證</button>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/checkout/checkout.do" style="margin-bottom: 0px;">
  ...
  <input type="hidden" name="tableno" value="<%=liveorderVO.getTableno()%>">
