			...
			<FORM METHOD="post" ACTION="MemberServlet.do" name="form1">
				<table>
					...
					<tr>
						...
						<td>
							<%
							if (memberVO.getGender().equals("男")) {
							%> <lable> <input type="radio" name="gender" value="男"
								checked>男</lable> <lable> <input type="radio"
								name="gender" value="女">女</lable>
						</td>
						<%
						} else {
						%>
						<lable> <input type="radio" name="gender" value="男">男</lable>
						<lable> <input type="radio" name="gender" value="女"
							checked>女</lable>
						</td>
						<%
						}
					...
					<tr>
						<td>帳號:</td>
						<td><input placeholder="請輸入帳號" name="maccount" size="15"
					...
					<tr>
						...
						<td>
							...
							%> <lable> <input type="radio" name="mem_state" value="1"
								checked>已啟用</lable> <lable> <input type="radio"
								name="mem_state" value="0">停權</lable> <%
 } else {
 %> <lable> <input type="radio" name="mem_state" value="1">已啟用</lable>
					...
					<tr>
						...
						<td>
							...
							%> <lable> <input type="radio" name="mem_verify"
								value="1" checked>已驗證</lable> <lable> <input
								type="radio" name="mem_verify" value="0">未驗證</lable> <%
 } else {
 %> <lable> <input type="radio" name="mem_verify" value="1">已驗證</lable>
