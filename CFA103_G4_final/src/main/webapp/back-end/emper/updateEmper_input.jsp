...
<%
  EmperVO emperVO = (EmperVO) request.getAttribute("emperVO"); //EmperServlet.java(Concroller), 存入req的emperVO物件
%>
<%-- --<%= emperVO==null %>--${emperVO.emperno}-- --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<table>
	<tr>
		...
		<td><%=emperVO.getEmperno()%></td>
	</tr>
	<tr>
		<td>員工姓名:</td>
		<td><input type="TEXT" name="emper_name" size="45" value="<%=emperVO.getEmper_name()%>" /></td>
	</tr>
...
<input type="hidden" name="emperno" value="<%=emperVO.getEmperno()%>">
