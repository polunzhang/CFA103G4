package com.news_pic.controller;
...
@WebServlet("/News_ImageFromDB")
public class News_ImageFromDB extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Connection con;

	public News_ImageFromDB() {
		super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
					...
					"SELECT NEWS_IMAGE FROM NEWS_PIC WHERE NEWSNO =" + id);
